...
metadata = {
    'id': 'method_rdkit_rdk5_16384_tanimoto',
    'representation': 'rdk5_16384',
    'similarity': 'tanimoto'
}
...
def create_model(ligands, decoys):
    ...
    return [Chem.RDKFingerprint(molecule, maxPath=5, fpSize=16384,
...
def compute_score(model, query):
    ...
    """
    fingerprint = Chem.RDKFingerprint(query, maxPath=5, fpSize=16384,
                                      nBitsPerHash=2)
