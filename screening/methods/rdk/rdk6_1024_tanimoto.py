...
metadata = {
    'id': 'method_rdkit_rdk6_1024_tanimoto',
    'representation': 'rdk6_1024',
    'similarity': 'tanimoto'
}
...
def create_model(ligands, decoys):
    ...
    return [Chem.RDKFingerprint(molecule, maxPath=6, fpSize=1024,
...
def compute_score(model, query):
    ...
    """
    fingerprint = Chem.RDKFingerprint(query, maxPath=6, fpSize=1024,
                                      nBitsPerHash=2)
